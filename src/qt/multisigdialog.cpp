...
void MultisigDialog::on_addAddressButton_clicked()
{
    ...
    QIcon icon3;
    icon3.addFile(QStringLiteral(":/icons/default/address-book"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    QIcon icon4;
    icon4.addFile(QStringLiteral(":/icons/default/editpaste"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    QIcon icon5;
    icon5.addFile(QStringLiteral(":/icons/default/remove"), QSize(), QIcon::Normal, QIcon::Off);
...
void MultisigDialog::on_addInputButton_clicked()
{
    ...
    QIcon icon;
    icon.addFile(QStringLiteral(":/icons/default/remove"), QSize(), QIcon::Normal, QIcon::Off);
