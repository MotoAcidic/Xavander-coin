                                                    ...
                                                    transactionView(0)
{
    ...
    watchOnlyWidget->addItem(QIcon(":/icons/default/eye_plus"), "", TransactionFilterProxy::WatchOnlyFilter_Yes);
    watchOnlyWidget->addItem(QIcon(":/icons/default/eye_minus"), "", TransactionFilterProxy::WatchOnlyFilter_No);
